 ...
 *
 * @param int|null $userId The user ID to check (default is null).
 *
 * @return int Returns:
 *   -1 if $userId is empty.
 *    0 if the email is not validated.
 *    1 if the email is validated.
 *    2 if the email is empty or not a valid email.
 */
